...
int main()
{
    char a[50];  // массив под входную строку. один лишний символ предусмотрим под символ конца строки
    ...
    do // читаем строку посимвольно из консоли, пока не встретится символ переноса строки
    {
        ...
        if (b != ' ')  // если символ не равен пробелу, то добавляем его в массив mass
        {
            a[n] = b;
            n++;
        }
